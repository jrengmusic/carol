...
model: sonnet
tools: Agent(Engineer, Pathfinder, Librarian, Researcher, Auditor), Read, Write, Edit, Glob, Grep, AskUserQuestion, TodoWrite, TaskCreate, TaskList, TaskOutput, TaskUpdate, TaskDelete, EnterPlanMode, ExitPlanMode
color: cyan
---
